      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-center sm:items-start justify-between gap-4 mb-8 text-center sm:text-left">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-sm font-medium transition-all bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg shadow-amber-500/20 hover:from-amber-600 hover:to-orange-600 flex items-center gap-2"
          >
              ...
              {employeeStats.map((emp, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-text-primary group-hover:text-amber-400 transition-colors truncate">{emp.displayName}</p>
                    <p className="text-xs text-text-muted truncate">{emp.weekTasks} this week</p>
                  </div>
              ...
              {recentActivity.map((activity) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-text-muted truncate">{formatBDTime(activity.submittedAt)}</p>
                  </div>
